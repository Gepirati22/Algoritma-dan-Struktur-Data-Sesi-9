public class DataZakatFitri {
  ...
  public DataZakatFitri(String nama, String alamat, String metodePembayaran, String sedekah2, int nominalSedekah) {
      this.nama = nama;
      this.alamat = alamat;
  ...
  public DataZakatFitri(String nama2, String alamat2, String metodePembayaran2, int jumlahZakat, String jawabanSedekah,
        int nominalSedekah2) {
}
